    ...
    const handleSend = () => {
        ...
        eventSource.onmessage = (event) => {
            ...
            try {
                ...
                const chunk = data.candidates?.[0]?.content?.parts?.[0]?.text || data.text || '';
                setMessages(prev => {
                    const newMsgs = [...prev];
                        ...
                        <div className="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
                            <div className="d-flex align-items-center gap-3">
                                <div className="bg-dark rounded-circle overflow-hidden shadow-sm" style={{width: '48px', height: '48px'}}>
                                    <img src="[https://api.dicebear.com/7.x/bottts/svg?seed=Felix&backgroundColor=1e293b](https://api.dicebear.com/7.x/bottts/svg?seed=Felix&backgroundColor=1e293b)" alt="AI" className="w-100 h-100" />
                                </div>
                                <div>
                        ...
                        <div className="card-body bg-light overflow-auto d-flex flex-column gap-3 p-4" ref={chatBoxRef}>
                            ...
                            {isGenerating && (
                                <div className="d-flex justify-content-start">
                                    <div className="bg-dark rounded-circle flex-shrink-0 me-3 mt-1" style={{width: '40px', height: '40px'}} />
                                    <div className="msg-bubble msg-ai shadow-sm d-flex gap-1 align-items-center">
